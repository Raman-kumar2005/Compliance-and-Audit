...
import { 
  ...
  ArrowRight, FileSpreadsheet, History, PlusCircle, ArrowLeft, Clock
} from 'lucide-react';
import axios from 'axios';
import html2pdf from 'html2pdf.js';
import { 
  PieChart, Pie, Cell, BarChart, Bar, XAxis, YAxis, CartesianGrid, 
  Tooltip as RechartsTooltip, Legend, LineChart, Line, ResponsiveContainer 
} from 'recharts';
...
export default function App() {
  const [activeTab, setActiveTab] = useState('new_audit'); // 'new_audit', 'history', 'report'
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-slate-100 font-sans selection:bg-indigo-500/30 flex flex-col">
      ...
      {/* Navigation Bar */}
      <nav className="bg-[#1e293b] border-b border-slate-700/50">
          ...
          <div className="bg-slate-50 text-slate-800 flex-1 w-full pt-8 pb-24 animate-in slide-in-from-bottom-8 duration-500" id="report-container">
            <div className="max-w-7xl mx-auto px-6 md:px-12">
              ...
              <div className="flex justify-between items-end mb-8">
                ...
                <button
                  onClick={exportPDF}
                  className="bg-[#059669] hover:bg-[#047857] text-white px-6 py-3 rounded-xl font-bold flex items-center gap-3 transition-all shadow-lg shadow-emerald-500/20 cursor-pointer"
                >
